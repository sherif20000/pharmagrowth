...
export default function TestimonialCard({ quote, name, role, company }: TestimonialCardProps) {
  return (
    <div className="bg-navy-900 border border-white/5 rounded-2xl p-6 lg:p-8 flex flex-col">
      {/* Stars */}
      ...
      {/* Quote */}
      <blockquote className="text-navy-300 text-sm leading-relaxed flex-1 mb-6">
        &ldquo;{quote}&rdquo;
      </blockquote>
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-navy-500 text-xs">{role}, {company}</p>
        </div>
      </div>
    </div>
  );
