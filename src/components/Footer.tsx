            ...
            <div className="flex gap-3">
              {socialLinks.map((link) => (
                <a
                  ...
                  className={`w-10 h-10 rounded-lg bg-white/8 ${link.hoverBg} text-white/60 hover:text-white flex items-center justify-center transition-all duration-200 hover:scale-105`}
                >
                  {link.icon}
                </a>
              ))}
